...
<html lang="en">
    <head>
        ...
        <title>Welcome ♦ Afrolago Rwanda</title>
    </head>
    <body>
        <header>
            ...
            <div class="icons">
                ...
                <a href="page-shopping-cart.php"><i class="fa fa-shopping-cart"></i></a>
                <a href="<?php if(!isset($_SESSION["user_id"])){echo "page-user-login.php";}else{echo "logout.php";}; ?>"><i class="fa fa-user"></i> <?php if(isset($_SESSION['user_id'])){ echo $row['firstname']; } ?></a>
            </div>
        </header>
        <!--end header-->

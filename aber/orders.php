...
<html>
<head>
	<title>Orders ♦ Afrolago Rwanda</title>
...
<body>	
    <div id="mySidenav" class="sidenav">
        ...
        <a href="orders.php"class="icon-a"  style="color: #f1f1f1; background-color:#1b203d;"><i class="fa fa-shopping-bag icons"></i> &nbsp;&nbsp;Orders</a>
